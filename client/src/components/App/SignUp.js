    ...
    return (
        <div className='container'>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <input type="text" name="firstName" placeholder="First Name" value={firstName} onChange={handleFirstNameChange} required /><br />
                {errors.firstName && <span className="error">Please enter your first name</span>}

                <input type="text" name="lastName" placeholder="Last Name" value={lastName} onChange={handleLastNameChange} required /><br />
                {errors.lastName && <span className="error">Please enter your last name</span>}

                <input type="text" name="userName" placeholder="Username" value={userName} onChange={handleUserNameChange} required /><br />
                {errors.userName && <span className="error">Please enter a username</span>}
                ...
                {errors.password && <span className="error">Please enter a password</span>}
